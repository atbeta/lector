...
const PATHS: Record<string, string> = {
  ...
  // 设置：齿轮。曾经是 lucide 的 settings-2（三根竖轨 + 三根横杠），
  // 那三根横杠顶到 viewBox 的 1/23，18px 下横向溢出感很重、像没画完；
  // 而且在顶栏里跟键盘按钮一样是"横竖线堆"，认不出谁是谁。齿轮没有这个歧义。
...
fileOutput: `<path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M4 7V4a2 2 0 0 1 2-2 2 2 0 0 0-2 2"/><path d="M4.063 20.999a2 2 0 0 0 2 1L18 22a2 2 0 0 0 2-2V7l-5-5H6"/><path d="m5 11-3 3"/><path d="m5 17-3-3h10"/>`,
palette: `<circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/>`,
  ...
  // 脚注跳回：左上回转箭头（lucide corner-up-left）
  backref: `<polyline points="9 14 4 9 9 4"/><path d="M20 20v-7a4 4 0 0 0-4-4H4"/>`,
  ...
  // 块把手：三个竖向点。与大纲按钮同形，但一个长在正文左留白里、一个长在顶栏，
  // 位置本身就分得开；块把手只用它表达「这块有一份操作菜单」。
  grip: `<circle cx="12" cy="5" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="12" cy="19" r="1.4"/>`,
  // 应用占位：带标题栏的小窗口。外部应用列表里拿不到 exe 图标时的替身。
