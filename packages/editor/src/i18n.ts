...
const zh = {
  ...
  loading: '加载中…',
  modeEnterEdit: '进入编辑模式 (⌘E)',
  modeExitEdit: '回到只读模式 (⌘E)',
  modeAria: '编辑模式',
  openAria: '打开',
  saveAria: '保存',
  outlineAria: '大纲',
  ...
  codeCopied: '已复制代码',
  codeCopyFailed: '复制失败',
  modeEnterWrite: '进入写作 (⌘2)',
  modeEnterSplit: '进入分屏 (⌘3)',
  modeEnterRead: '回到只读 (⌘1)',
  modeLabelRead: '只读',
  modeLabelWrite: '写作',
  modeLabelSplit: '分屏',
  mermaidLoading: '渲染中…',
...
const en: Record<keyof typeof zh, string> = {
  ...
  loading: 'Loading…',
  modeEnterEdit: 'Enter edit mode (⌘E)',
  modeExitEdit: 'Back to read-only (⌘E)',
  modeAria: 'Edit mode',
  openAria: 'Open',
  saveAria: 'Save',
  outlineAria: 'Outline',
  ...
  modeEnterWrite: 'Enter write mode (⌘2)',
  modeEnterSplit: 'Enter split mode (⌘3)',
  modeEnterRead: 'Back to read-only (⌘1)',
  modeLabelRead: 'Read',
  modeLabelWrite: 'Write',
  modeLabelSplit: 'Split',
