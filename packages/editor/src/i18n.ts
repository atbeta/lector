...
export const zh = {
  ...
  discardAction: '放弃改动',
  cancelAction: '取消',
  largeFileNotice: '文件过大（{size} MB）：只读预览，已铺开 {shown} / {total} 行，滚动继续加载；本模式不保存。',
  largeFileNoticeAll: '文件过大（{size} MB）：已铺开全部 {total} 行；只读预览，本模式不保存。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  cancelAction: 'Cancel',
  largeFileNotice: 'Large file ({size} MB): read-only preview, {shown} of {total} lines shown; scroll to load more. Saving is off.',
  largeFileNoticeAll: 'Large file ({size} MB): all {total} lines shown; read-only preview, saving is off.',
